...
async function doDeploy(deployer, network, accounts, _oA, _mA, _cA) {
    ...
    await deployer.deploy(SmartPlacesProtocol, _mA, _cA);
}
...
module.exports = (deployer, network, accounts) => {
    deployer.then(async () => {
        ...
        const charityAddr = "0x22E436d0A1FCe57146465475B8eB2a5a0728e105";
        await doDeploy(deployer, network, accounts, ownerAddr, marketingAddr, charityAddr);
    })
